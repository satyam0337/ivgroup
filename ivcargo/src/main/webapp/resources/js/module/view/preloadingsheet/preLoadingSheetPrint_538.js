define(['elementTemplateJs'
	...
	return ({
		renderElements : function(response){
			...
			require(['text!/ivcargo/template/preloading/preLoadingSheetPrint_538.html'],function(PreLoadingSheet){
				...
				_this.setTableRowData(finalJsonObj,allTypeChargedWeightTotal,allTypeActualWeightTotal,totalNoOfQuantity,bookingTotalToPay,noOfLRPaid,noOfLRToPay,noOfLRTBB);
				hideLayer();	
				_this.showPrintOnPopup();
			})
			
		},setTableRowData:function(tableData,allTypeChargedWeightTotal,allTypeActualWeightTotal,totalNoOfQuantity,bookingTotalToPay,noOfLRPaid,noOfLRToPay,noOfLRTBB){
			hideLayer();
			$('#mainTable').empty();
			    ...
			    let headerColumnArray = [
			        '<th style="text-align: center;font-size:15px;  border-right: 1px solid black; border-bottom: 1px solid black;">SRNo</th>',
			        '<th style="text-align: center;font-size:15px;  border-right: 1px solid black; border-bottom: 1px solid black;">BK DT</th>',
			        '<th style="text-align: center;font-size:15px;  border-right: 1px solid black; border-bottom: 1px solid black;">LR No.</th>',
			        '<th style="text-align: center;font-size:15px;  border-right: 1px solid black;border-bottom: 1px solid black;">ORG </th>',
			        '<th style="text-align: center;font-size:15px;  border-right: 1px solid black;border-bottom: 1px solid black;">DEST</th>',
			        '<th style="text-align: center;font-size:15px;  border-right: 1px solid black; border-bottom: 1px solid black;">C/NOR</th>',
			        '<th style="text-align: center;font-size:15px;  border-right: 1px solid black; border-bottom: 1px solid black;">C/NEE</th>',
			        '<th style="text-align: center;font-size:15px;  border-right: 1px solid black; border-bottom: 1px solid black;">ART.</th>',
			        '<th style="text-align: center;font-size:15px;  border-right: 1px solid black; border-bottom: 1px solid black;">ART DTLS</th>',
			        '<th style="text-align: center;font-size:15px;  border-right: 1px solid black; border-bottom: 1px solid black;">ACT.WEIGHT</th>',
			        '<th style="text-align: center;font-size:15px;  border-right: 1px solid black; border-bottom: 1px solid black;">CH.WEIGHT</th>',
			        '<th style="text-align: center;font-size:15px; border-bottom: 1px solid black; ">FREIGHT</th>',
          ...
          for (var i = 1; i < tableData.length; i++) {
				...
				dataColumnArray.push("<td style='text-align: center; white-space: nowrap; overflow: hidden; text-overflow: ellipsis; border-right: 1px solid black; border-bottom: 1px solid black; max-width: 100px;'>"+ el.consignorName +"</td>");
				dataColumnArray.push("<td style='text-align: center; white-space: nowrap; overflow: hidden; text-overflow: ellipsis; border-right: 1px solid black; border-bottom: 1px solid black; max-width: 100px;'>"+ el.consigneeName +"</td>");
				dataColumnArray.push("<td style='text-align: center; border-right: 1px solid black; border-bottom: 1px solid black;'>"+ el.quantity +"</td>");
				dataColumnArray.push("<td style='text-align: center; border-right: 1px solid black; border-bottom: 1px solid black;'>"+ el.packingTypeMasterName +"</td>");
				dataColumnArray.push("<td style='text-align: center; border-right: 1px solid black; border-bottom: 1px solid black;'>"+ el.consignmentSummaryActualWeight +"</td>");
				dataColumnArray.push("<td style='text-align: center; border-right: 1px solid black; border-bottom: 1px solid black;'>"+ el.consignmentSummaryChargedWeight +"</td>");
				if (el.topayFreightTotal == 0)
				    dataColumnArray.push("<td style='text-align: center; border-bottom: 1px solid black;'>"+ el.wayBillType +"</td>");
				else
				    dataColumnArray.push("<td style='text-align: center; border-bottom: 1px solid black;'>"+ el.topayFreightTotal +"</td>");
		    ...
		    for (let i=1; i <=headerColumnArray.length; i++) {
				if(i==10){
				 totalDataArray.push("<td style='text-align: center; border-left: 1px solid black; border-right: 1px solid black; font-weight: bold;'>" +allTypeActualWeightTotal  + "</td>");
					...
					totalDataArray.push("<td style='text-align: center; border-right: 1px solid black; font-weight: bold;'>" + allTypeChargedWeightTotal + "</td>");
				}else if(i==12){
				  totalDataArray.push("<td style='text-align: center; font-weight: bold;'>" + bookingTotalToPay + "</td>");
				}else if(i==8){
