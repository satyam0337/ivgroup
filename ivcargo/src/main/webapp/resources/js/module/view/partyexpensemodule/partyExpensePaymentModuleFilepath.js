define(function(require) {
	return {
		loadLanguage:function(){
			...
			globalLanguageObj.filePath 		= PROJECT_IVUIRESOURCES+'/resources/data/languages/module/partyexpensemodule';
			//file name for language to be specified
			globalLanguageObj.fileName 		= 'partyExpensePaymentModule'
