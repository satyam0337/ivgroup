define(['elementTemplateJs'
	...
	return ({
		renderElements : function(response){
			...
			require(['text!/ivcargo/template/preloading/preloadingsheet_1.html'],function(PreLoadingSheet){
			...
			if(sortWayBillNumberWithoutBranchCode == 'true' || sortWayBillNumberWithoutBranchCode == true){
				console.log("sortWayBillNumberWithoutBranchCode::-- " + sortWayBillNumberWithoutBranchCode)
