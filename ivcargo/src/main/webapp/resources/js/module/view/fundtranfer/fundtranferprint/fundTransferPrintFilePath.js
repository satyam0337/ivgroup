define(function(require) {
	return {
		loadLanguage:function(fundTranferPrintFlavor){
			...
			globalLanguageObj.filePath 		= PROJECT_IVUIRESOURCES+'/resources/data/languages/module/fundtransfer';
			//file name for language to be specified
			globalLanguageObj.fileName 		= fundTranferPrintFlavor
