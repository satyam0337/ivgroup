...
function Datepicker() {
	this._defaults = {
		...
		showOnFocus: true, // True for popup on focus, false for notR
		showTrigger: null, // Element to be cloned for a trigger, null for none
		showAnim: 'show', // Name of jQuery animation for popup, '' for no animation, 'show' for animation
		showOptions: {}, // Options for enhanced animations
		showSpeed: 'fast', // Duration of display/closure change to normal
...
//		
	...
	/* Return today's date.
	   @return  (Date) today */
	today: function() {
		return this._normaliseDate(curSystemDate);
	},
