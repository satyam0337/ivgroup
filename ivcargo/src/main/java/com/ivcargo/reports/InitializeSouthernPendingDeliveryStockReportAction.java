...
public class InitializeSouthernPendingDeliveryStockReportAction implements Action {
	...
	public void execute(HttpServletRequest request, HttpServletResponse response) {
		...
		try {
			...
			subRegions = cacheManip.getSubRegionsByGroupId(request, executive.getAccountGroupId());
