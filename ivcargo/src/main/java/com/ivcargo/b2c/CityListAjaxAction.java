...
public class CityListAjaxAction  implements Action {

	private static final String TRACE_ID = CityListAjaxAction.class.getName();
	...
	public void execute(HttpServletRequest request, HttpServletResponse response) {
		...
		try {
			...
			if(lrTrackingAllow)
				outValueObject = WSUtility.callPostWebService(WSUtility.getWebServiceUrl("" + WebServiceURI.CITY_LIST), module.toString());
