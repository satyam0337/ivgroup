...
public class InitializeCreditorPaymentModuleAction implements Action {
	public void execute(HttpServletRequest request, HttpServletResponse response) {
		...
		try {
			...
			CorporateAccount[] corporate = CorporateAccountDao.getInstance().findAllCorporateByAccountGroupId(executive.getAccountGroupId()); 
