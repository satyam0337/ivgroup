/**
 * @Author Anant Chaudhary	05-11-0216
 */
...
define(function(require) {
	return {
		loadLanguage:function(){
			...
			globalLanguageObj.filePath 		= PROJECT_IVUIRESOURCES+'/resources/data/languages/module/crossingHisab';
			//file name for language to be specified
			globalLanguageObj.fileName 		= 'crossingHisabSettlementCancellation'
