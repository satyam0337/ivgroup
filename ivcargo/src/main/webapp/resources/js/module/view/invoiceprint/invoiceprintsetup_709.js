		...
		setPopup : function(accountGroupId, data) {
			$('#popUpContent_' + accountGroupId).bPopup({
					...
					$(this).html("<div class='confirm' style='font-size:18px;height:200px;width:350px;padding-left:15px;'>"
							+"<b style='text-align:center;padding-left:120px;padding-top:10px;'>Print Option</b><br/><br/>"						
							+"<input type='radio' id='withHeader' name='radio1'/>&nbsp;<b style='font-size:14px;text-align:left;color:DodgerBlue;'>With Header</b><br/><br/>"
