		...
		setPopup : function(accountGroupId, data) {
			$('#popUpContent_' + accountGroupId).bPopup({
				...
				function removeClass2() {
					...
					$("[data-bankDeatils='accountNo']").html("3783936592");
					$("[data-bankDeatils='ifscCode']").html("CBIN0185066");
					
				let doesFormat5RequireExtraTd = true;
				...
				$(document).ready(function() {
					...
					$('input[id="formatter1"]').click(function() {
						...
						if ($("#Formatter1").prop("checked", true)) {
							...
							doesFormat5RequireExtraTd = true
						}
					});
					...
					$('input[id="formatter2"]').click(function() {
						...
						if ($("#formatter2").prop("checked", true)) {
							...
							$(".formater2").removeClass('hide');
							$('.extraFor2and5').removeClass('hide');
							doesFormat5RequireExtraTd = true
						}
					});
					$('input[id="formatter3"]').click(function() {
						...
						if ($("#formatter").prop("checked", true)) {
							...
							$(".formater2").addClass('hide');
							$('.extraFor2and5').addClass('hide');
							doesFormat5RequireExtraTd = false
						}
					});
                    ...
                    $('input[id="yesBank"]').click(function() {
						if ($("#yesBank").prop("checked", true)) {
							...
							$("[data-bankDeatils='branchName']").html("SEAWOOD");
							$("[data-bankDeatils='accountNo']").html("020061900000078");
