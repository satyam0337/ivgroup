...
function ShowDialogForPrint_printOption(){
	$("#companyNameOverlay_printOption").show();
	$("#companyNameDialog_printOption").fadeIn(300);
}
...
function HideSaidToContainDialog(){
    ...
    ShowDialogForPrint_printOption()
}

function setNewPrint() {
	$("#companyNameOverlay_printOption").hide();
    $("#companyNameDialog_printOption").fadeOut(0);
