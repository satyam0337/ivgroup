...
public class InitializeDeliveredReportAction implements Action {
	...
	public void execute(final HttpServletRequest request, final HttpServletResponse response) {
		...
		try {
			...
			if(!ActionStaticUtil.isAllowToAccessOperation(error, cacheManip, request, BusinessFunctionConstants.DELIVERED_STOCK_REPORT, BusinessFunctionConstants.PERMISSION_TYPE_REPORT)) {
