/**
 * @Author Anant Chaudhary 03-05-2017
 */
...
define(function(require) {
	return {
		loadLanguage : function() {
			...
			globalLanguageObj.filePath 		= PROJECT_IVUIRESOURCES+'/resources/data/languages/module/fastTagTollDetailsReport';
			//file name for language to be specified
			globalLanguageObj.fileName 		= 'fastTagTollDetailsReport'
