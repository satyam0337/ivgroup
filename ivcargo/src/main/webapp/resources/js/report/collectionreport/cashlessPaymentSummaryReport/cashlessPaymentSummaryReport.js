define([
	...
	return Marionette.LayoutView.extend({
		initialize : function() {
			...
			$("#mainContent").load("/ivcargo/html/report/collectionreport/cashlessPaymentSummaryReport/cashlessPaymentSummaryReport.html",function() {
				baseHtml.resolve();
			});
			...
			getJSON(jsonObject, WEB_SERVICE_URL+'/cashlessPaymentReportWS/getCashlessPaymentSummaryReportDetails.do', _this.setReportData, EXECUTE_WITH_ERROR);
