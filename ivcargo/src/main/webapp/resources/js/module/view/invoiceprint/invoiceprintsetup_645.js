		...
		setPopup : function(accountGroupId, data) {
			$('#popUpContent_' + accountGroupId).bPopup({
				...
				$(this).html("<div class='confirm' style='font-size:18px;height:350px;text-align:center;width:450px;color:DodgerBlue;>"
					...
					+ "<input type='radio' id='yesBank' checked='checked' name='radio2'/>&nbsp;<b style='font-size:16px;'>YES BANK</b>"
					+ "<input type='radio' id='centralBank'  name='radio2'/>&nbsp;<b style='font-size:16px;'>CENTRAL BANK OF INDIA</b><br>"
				...
				$("[data-bankDeatils='branchName']").html("SEAWOODS");
				$("[data-bankDeatils='accountNo']").html("020063300001522");
				...
				$(document).ready(function() {
					...
					$('input[id="centralBank"]').click(function() {
						if ($("#centralBank").prop("checked", true)) {
							...
							$("[data-bankDeatils='accountNo']").html("3861386639");
