define(['elementTemplateJs'
	...
	return ({
		renderElements : function(response){
			...
			require(['text!/ivcargo/template/preloading/preloadingsheet_20.html'],function(PreLoadingSheet){
			...
			for(var i=0;(pendingSheet[sourceArray[index]]).length > i;i++){
				...
				var check = this.isValueExistInArray(destBranchArray,destBranch);
