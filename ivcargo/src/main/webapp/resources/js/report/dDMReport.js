define([
	...
	return Marionette.LayoutView.extend({
		initialize: function() {
			...
			getJSON(jsonObject, WEB_SERVICE_URL + '/report/dDMReportWS/getDDMReportElement.do?', _this.setDDMReportElements, EXECUTE_WITHOUT_ERROR);
			return _this;
		}, setDDMReportElements: function(response) {
			...
			$("#mainContent").load("/ivcargo/html/report/dDMReport/dDMReport.html", function() {
				baseHtml.resolve();
			});
			...
			getJSON(jsonObject, WEB_SERVICE_URL + '/report/dDMReportWS/getDDMReportDetails.do', _this.setReportData, EXECUTE_WITH_ERROR);
