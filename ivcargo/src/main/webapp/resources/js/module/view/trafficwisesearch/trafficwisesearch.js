...
define([
        ...
        ,PROJECT_IVUIRESOURCES+'/resources/js/module/view/trafficwisesearch/trafficwisesearchelements.js'//Elements
        //this is called to get the elements
        ,'text!'+PROJECT_IVVIEWPAGES+'/template/pagetemplatefortrafficsearch.html'//Template
        ...
        ,PROJECT_IVUIRESOURCES+'/resources/js/module/view/trafficwisesearch/trafficwisesearchbehaivour.js'
        ,PROJECT_IVUIRESOURCES+'/resources/js/module/view/trafficwisesearch/actionbutton/actionbuttonview.js'//,AcctionbuttonView
	...
	return Marionette.LayoutView.extend({
		...
		triggers: {
			"click #searchBtn": "searchLRDetails",
			"click #printBtn": "printLRDetails"
		},
		events: {
			"click .showDetails": "showTrafficDetails",
			"click .hideDetails": "hideTrafficDetails"
		},
		behaviors: {
			SearchBehavior: {
				behaviorClass: SearchBehavior,
				fieldSelector: "#ElementDiv :input"
			}
		},
		showTrafficDetails : function(e) {
		    var btn_id = $(e.currentTarget).context.id;
		    
		    $(".showhidesubregiondetails_" + btn_id.split('_')[1]).show();
		    $(".minus_" + btn_id.split('_')[1]).show();
		    $(".plus_" + btn_id.split('_')[1]).hide();
		},
		hideTrafficDetails : function(e) {
		    var btn_id = $(e.currentTarget).context.id;
		    
		    $(".showhidesubregiondetails_" + btn_id.split('_')[1]).hide();
		    $(".plus_" + btn_id.split('_')[1]).show();
		    $(".minus_" + btn_id.split('_')[1]).hide();
		}
	});
});