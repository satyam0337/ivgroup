   ...
   /* ,JS_RESOURCES + '/resources/js/dashboard/html2canvas.min.js'*/
	...
	return Marionette.LayoutView.extend({
		initialize: function () {
			...
			getJSON(jsonObject, WEB_SERVICE_URL + '/dashboard/getDashboardElementConfiguration.do?', _this.getElementConfigDetails, EXECUTE_WITHOUT_ERROR);
			return _this;
			...
			$("#mainContent").load("/ivcargo/html/dashboard/dashboard.html", function () {
				baseHtml.resolve();
			});
			...
			getJSON(jsonObject, WEB_SERVICE_URL + '/dashboard/getTheBarChartEvent.do', _this.setTheBarChartEvent, EXECUTE_WITH_ERROR);
 ...
  					mywindow.document.close(); 
		   ...
		   if(thisMonthOrLastMonth){
			...
			if ($("#compareCheck").prop("checked"))
				getJSON(jsonObject, WEB_SERVICE_URL + '/dashboard/getTheChart.do', _this.setComparisonData, EXECUTE_WITH_ERROR);
			else
				getJSON(jsonObject, WEB_SERVICE_URL + '/dashboard/getTheChart.do', _this.printChartFirst, EXECUTE_WITH_ERROR);
		}
	});
});