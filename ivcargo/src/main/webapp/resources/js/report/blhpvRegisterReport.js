define([
	...
	return Marionette.LayoutView.extend({
		initialize: function() {
			...
			getJSON(jsonObject, WEB_SERVICE_URL + '/report/blhpvRegisterReportWS/getBlhpvRegisterReportElement.do?', _this.setBlhpvRegisterReportElements, EXECUTE_WITHOUT_ERROR);
			return _this;
		}, setBlhpvRegisterReportElements: function(response) {
			...
			$("#mainContent").load("/ivcargo/html/report/blhpvRegisterReport/blhpvRegisterReport.html", function() {
				baseHtml.resolve();
			});
			...
			getJSON(jsonObject, WEB_SERVICE_URL + '/report/blhpvRegisterReportWS/getBlhpvRegisterReportDetails.do', _this.setReportData, EXECUTE_WITH_ERROR);
