...
function printLhpvWindow() {
	$("#tableContain").load( "/ivcargo/jsp/print/lhpv/239/aciplledgerLHPVPrint.html", function() {
...
function setLoadingSheetDetails() {
	...
	if(dispatchLedgerArrlist != null) {
		for(var i = 0; i < dispatchLedgerArrlist.length; i++) {
			...
			var row				= createRowInTable('loadingSheet_' + (i + 1), '', 'height: 10px; letter-spacing: 9px;');
