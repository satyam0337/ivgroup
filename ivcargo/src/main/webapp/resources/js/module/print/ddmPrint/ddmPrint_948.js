define([], function() {
	return {
		...
		createWaybillRow: function(rowTemplate, wb, srNo) {
			...
			this.setTextIfExists(tr, "[data-setWaybill='date']", wb.deliveryDateTimeString);
			this.setTextIfExists(tr, "[data-setWaybill='packageQuantity']", wb.quantityWithPackingType);
			...
			this.setTextIfExists(tr, "[data-setWaybill='wayBillTypePaid']",wb.wayBillTypeId == 1 ? wb.wayBillGrandTotal : 0);
			this.setTextIfExists(tr, "[data-setWaybill='wayBillTypeTopay']",wb.wayBillTypeId == 2 ? wb.wayBillGrandTotal : 0);
