define(function(require) {
	return {
		loadLanguage:function(){
			...
			globalLanguageObj.filePath 		= PROJECT_IVUIRESOURCES+'/resources/data/languages/module/deliveryStockClearMaster';
			//file name for language to be specified
			globalLanguageObj.fileName 		= 'deliveryStockClearMaster'
