...
public class CollectionPersonViewCreditLRDetailsAction implements Action {

	public static final String TRACE_ID = "CollectionPersonViewCreditLRDetailsAction";
	...
	public void execute(HttpServletRequest request, HttpServletResponse response) {
		...
		try {
			...
			if(collectionPersonId > 0 && branchId > 0){

				outValueObject = CollectionPersonWiseSummaryReportDAO.getInstance().getCollectionPersonDataForCreditpaymentReportLRDetails(collectionPersonId, branchId, fromDate, toDate);
