define(
	...
	return Marionette.LayoutView.extend({
		initialize : function() {
			...
			getJSON(null, WEB_SERVICE_URL+'/pickUpLSRegisterReportWS/getPickUpLSRegisterReportElement.do', _this.renderElements, EXECUTE_WITH_ERROR);
			return _this;
			...
			$("#mainContent").load("/ivcargo/html/report/dispatchreport/pickUpLSRegisterReport/pickUpLSRegisterReportDetail.html",
					function() {
				baseHtml.resolve();
			});
			...
			getJSON(jsonObject, WEB_SERVICE_URL+'/pickUpLSRegisterReportWS/getPickUpLsRegisterDetails.do', _this.setData, EXECUTE_WITH_ERROR);
