define(function(require) {
	return {
		loadLanguage:function(){
			...
			globalLanguageObj.filePath 		= PROJECT_IVUIRESOURCES+'/resources/data/languages/module/pendingChequeBounceReport';
			//file name for language to be specified
			globalLanguageObj.fileName 		= 'pendingChequeBounceReport'
