define([
	...
	return Marionette.LayoutView.extend({
		initialize: function() {
			...
			getJSON(jsonObject, WEB_SERVICE_URL + '/report/bookingSummaryDestinationWiseReportWS/getBookingSummaryDestinationWiseReportElement.do?', _this.setBookingSummaryDestinationWiseReportElements, EXECUTE_WITHOUT_ERROR);
			return _this;
		}, setBookingSummaryDestinationWiseReportElements: function(response) {
			...
			$("#mainContent").load("/ivcargo/html/report/bookingSummaryDestinationWiseReport/bookingSummaryDestinationWiseReport.html", function() {
				baseHtml.resolve();
			});
			...
			getJSON(jsonObject, WEB_SERVICE_URL + '/report/bookingSummaryDestinationWiseReportWS/getBookingSummaryDestinationWiseReportDetails.do', _this.setReportData, EXECUTE_WITH_ERROR);
