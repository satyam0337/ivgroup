define(function(require) {
	return {
		loadLanguage:function(){
			...
			globalLanguageObj.filePath 		= PROJECT_IVUIRESOURCES+'/resources/data/languages/module/dispatch';
			//file name for language to be specified
			globalLanguageObj.fileName 		= 'dispatch'
			...
			globalLanguageObj.filePath 		= PROJECT_IVUIRESOURCES+'/resources/data/languages/module/dispatch';
			//file name for language to be specified
			globalLanguageObj.fileName 		= 'dispatch-'+accountGroupId;
			return globalLanguageObj;
		}
	}
})
