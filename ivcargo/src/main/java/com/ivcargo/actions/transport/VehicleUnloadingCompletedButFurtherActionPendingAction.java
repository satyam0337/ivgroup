...
public class VehicleUnloadingCompletedButFurtherActionPendingAction implements Action {
	@Override
	public void execute(HttpServletRequest request, HttpServletResponse response) {
		...
		try {
			...
			if(branchIds != null && branchIds.length() > 0){
				...
				inValueObject.put("status",VehiclePendingForUnLoading.STATUS_UNLOADING_COMPLETED);
