...
function printBillWindow() {
	...
	$("#tableContain").load( "/ivcargo/html/print/delivery/670_deliveryprint.html", function() {
...
function showDialogForAutoChargeInput() {
	console.log('inn',showAutoCharge);
	if(showAutoCharge){
...
function getTotalAmt() {
	...
	if(deliveryBranch.branchId == 19705 || deliveryBranch.branchId == 20620){
		companyHeader = 'Bombay Andhra Transport Organisation Cargo';
	}
