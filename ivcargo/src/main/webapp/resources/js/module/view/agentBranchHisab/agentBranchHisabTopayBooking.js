define([
	...
	,PROJECT_IVUIRESOURCES + '/resources/js/module/view/agentBranchHisab/agentbranchhisabtopaybookingfilepath.js'
	,'jquerylingua'
	,'language'
	,'slickGridWrapper2'
	...
	return Marionette.LayoutView.extend({
		initialize : function(jsonObjectData) {
			...
			getJSON(jsonObject, WEB_SERVICE_URL + '/agentBranchHisabWS/getAgentBranchHisabTopayBookingDetails.do?', _this.renderAgentBranchHisabTopayBookingElements, EXECUTE_WITH_ERROR);
			return _this;
			...
			setTimeout(function() {
				$("#modalBody").load("/ivcargo/html/module/AgentBranchHisab/agentBranchHisabTopayBooking.html",function() {
					baseHtml.resolve();
				});
			},200);
			
			if(response.message != undefined){
				refreshAndHidePartOfPage('topayBookingDetailsDiv', 'hide');
				hideLayer();
