define(['elementTemplateJs'
	...
	return ({
		renderElements : function(response){
			...
			isPrivateMark   =  response.isPrivateMark;
			isRemark   		=  response.isRemark;
			...
			require(['text!/ivcargo/template/preloading/preloadingsheet_17.html'],function(PreLoadingSheet){
				...
				if(!isPrivateMark){
					$(".isPrivateMarkCol").css({'color':'white','border':'white solid 1px'});
					$(".isPrivateMarkCol").html("");
					$(".isPrivateMarkCol").each(function(){
						$(this).removeClass("borderLeft");
						$(this).addClass("noBorder");
					})
				}
				if(!isRemark){
					$(".isRemarkCol").css({'color':'white','border':'white solid 1px'});
					$(".isRemarkCol").html("");
					$(".isRemarkCol").each(function(){
						$(this).removeClass("borderLeft");
						$(this).addClass("noBorder");
					})
				}
