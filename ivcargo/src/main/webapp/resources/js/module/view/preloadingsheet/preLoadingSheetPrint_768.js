define(['elementTemplateJs'
	...
	return ({
		renderElements : function(response){
			...
			this.setDataForView(this.setSortedSources(pendingSheet));
		},setDataForView:function(finalJsonObj){
			
			
			require(['text!/ivcargo/template/preloading/preLoadingSheetPrint_768.html'],function(PreLoadingSheet){
				...
				_this.setTableRowData(finalJsonObj,allTypeChargedWeightTotal,allTypeActualWeightTotal,totalBookingTotal,totalNoOfQuantity,bookingTotalToPay,noOfLRPaid,noOfLRToPay,noOfLRTBB);
				hideLayer();	
				_this.showPrintOnPopup();
			})
			
		},setTableRowData:function(tableData,allTypeChargedWeightTotal,allTypeActualWeightTotal,totalBookingTotal,totalNoOfQuantity,bookingTotalToPay,noOfLRPaid,noOfLRToPay,noOfLRTBB){
			hideLayer();
			$('#mainTable').empty();
			    ...
			    let headerColumnArray = [
			        '<th style="text-align: center;font-size:15px;  border-right: 1px solid black; border-bottom: 1px solid black;">SR.</th>',
			        '<th style="text-align: center;font-size:15px;  border-right: 1px solid black; border-bottom: 1px solid black;">LR NO.</th>',
			        '<th style="text-align: center;font-size:15px;  border-right: 1px solid black; border-bottom: 1px solid black;">BKG.DATE</th>',
			        '<th style="text-align: center;font-size:15px;  border-right: 1px solid black;border-bottom: 1px solid black;">TO</th>',
			        '<th style="text-align: center;font-size:15px;  border-right: 1px solid black; border-bottom: 1px solid black;">ART</th>',
			        '<th style="text-align: center;font-size:15px;  border-right: 1px solid black; border-bottom: 1px solid black;">PKG TYPE</th>',
			        '<th style="text-align: center;font-size:15px;  border-right: 1px solid black; border-bottom: 1px solid black;">WEIGHT</th>',
			        ...
			        '<th style="text-align: center;font-size:15px;  border-right: 1px solid black; border-bottom: 1px solid black;">DELIVERY TYPE</th>',
			        '<th style="text-align: center;font-size:15px;  border-right: 1px solid black; border-bottom: 1px solid black;">AMOUNT</th>',
          ...
          for (var i = 0; i < tableData.length; i++) {
				...
				dataColumnArray.push("<td style='font-size:15px; text-align: center; border-right: 1px solid black; border-bottom: 1px solid black;'>"+ (++index) +"</td>");
				...
				dataColumnArray.push("<td style='font-size:15px; text-align: center; border-right: 1px solid black; border-bottom: 1px solid black;'>"+ el.destinationBranchCode +"</td>");
				...
				dataColumnArray.push("<td style='font-size:15px; text-align: center; border-right: 1px solid black; border-bottom: 1px solid black;'>"+ el.packingTypeMasterName +"</td>");
				dataColumnArray.push("<td style='font-size:15px; text-align: center; border-right: 1px solid black; border-bottom: 1px solid black;'>"+ el.consignmentSummaryActualWeight+"/"+ el.consignmentSummaryChargedWeight +"</td>");
				dataColumnArray.push("<td style='font-size:15px; text-align: center; white-space: nowrap; overflow: hidden; text-overflow: ellipsis; border-right: 1px solid black; border-bottom: 1px solid black; max-width: 100px;'>"+ el.consignorName +"</td>");
				dataColumnArray.push("<td style='font-size:15px; text-align: center; white-space: nowrap; overflow: hidden; text-overflow: ellipsis; border-right: 1px solid black; border-bottom: 1px solid black; max-width: 100px;'>"+ el.consigneeName +"</td>");
				dataColumnArray.push("<td style='font-size:15px; text-align: center; border-right: 1px solid black; border-bottom: 1px solid black;'>"+ el.deliveryType +"</td>");
				dataColumnArray.push("<td style='font-size:15px; text-align: center; border-right: 1px solid black; border-bottom: 1px solid black;'>"+ el.bookingTotal +"</td>");
		    ...
		    for (let i=1; i <=headerColumnArray.length; i++) {
				if(i==11){
				 totalDataArray.push("<td style='font-size:15px; text-align: center; border-left: 1px solid black; border-right: 1px solid black; font-weight: bold;'>" +  totalBookingTotal + "</td>");
				}else if(i==2){
					totalDataArray.push("<td style='font-size:15px; text-align: center; border-right: 1px solid black; font-weight: bold;'>TOTAL</td>");
				}else if(i==5){
				  totalDataArray.push("<td style='font-size:15px; text-align: center;border-right: 1px solid black; font-weight: bold;'>" + totalNoOfQuantity + "</td>");
				}else if(i==7){
				  totalDataArray.push("<td style='font-size:15px; text-align: center;border-right: 1px solid black; font-weight: bold;'>" + allTypeActualWeightTotal + "/"+ allTypeChargedWeightTotal + "</td>");
				}else{
			...
			for(var i = 0; pendingSheet.length > i; i++) {
				pendingSheet[i].srNo	= Number(i + 1);
			}
