...
public class InitializeBranchWiseIncomeExpenseReportAction implements Action{

	public static final String TRACE_ID = InitializeBranchWiseIncomeExpenseReportAction.class.getName();
