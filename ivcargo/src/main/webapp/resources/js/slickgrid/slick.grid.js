...
(function ($) {
	...
	function SlickGrid(container, data, columns, options) {
		...
		function setPageHasChanged(){
			trigger(grid.onPageChanged, {}); // fire when page No changed is done
		}
...
//						updateCanvasWidth()
		...
		function appendCellHtml(stringArray, row, cell, colspan, item) {
			...
			stringArray.push("<div id='"+m.id+"_"+row+"' class='" + cellCss + " " +m.id+"'>");
		...
		function makeActiveCellEditable(editor) {
			...
			currentEditor = new (editor || getEditor(activeRow, activeCell))({
				...
				commitChangesWithoutFocus: commitEdit,
