define(function(require) {
	return {
		loadLanguage:function(){
			...
			globalLanguageObj.filePath 		= PROJECT_IVUIRESOURCES+'/resources/data/languages/print/consolidatedBLHPVPrint';
			//file name for language to be specified
			globalLanguageObj.fileName 		= 'consolidatedBLHPVPrint_675'
