define(['elementTemplateJs'
	...
	return ({
		renderElements : function(response){
			...
			require(['text!/ivcargo/template/preloading/preLoadingSheetPrint_13.html'],function(PreLoadingSheet){
			...
			$('#mainTable').empty();
			    ...
			    let headerColumnArray = [
			        ...
			        '<th style="text-align: center;font-size:15px;  border-right: 1px solid black; border-bottom: 1px solid black;">BKG.Branch</th>',
			        '<th style="text-align: center;font-size:15px;  border-right: 1px solid black;border-bottom: 1px solid black;">Destination</th>',
			        '<th style="text-align: center;font-size:15px;  border-right: 1px solid black; border-bottom: 1px solid black;">No of Art</th>',
			        '<th style="text-align: center;font-size:15px;  border-right: 1px solid black; border-bottom: 1px solid black;"> Art Type</th>',
			        '<th style="text-align: center;font-size:15px;  border-right: 1px solid black; border-bottom: 1px solid black;">Count</th>',
          ...
          for (var i = 0; i < tableData.length; i++) {
				...
				dataColumnArray.push("<td style='font-size:15px; text-align: center; border-right: 1px solid black; border-bottom: 1px solid black;'>"+ el.wayBillSourceBranchName	 +"</td>");
				...
				dataColumnArray.push("<td style='font-size:15px; text-align: center; border-right: 1px solid black; border-bottom: 1px solid black;'> </td>");
		    ...
		    for (let i=1; i <=headerColumnArray.length; i++) {
				if(i==11){
				 totalDataArray.push("<td style='font-size:15px; text-align: center; border-left: 1px solid black; border-right: 1px solid black; font-weight: bold;'> </td>");
				}else if(i==5){
				  ...
				  totalDataArray.push("<td style='font-size:15px; text-align: center;border-right: 1px solid black; font-weight: bold;'> </td>");
				}else{
