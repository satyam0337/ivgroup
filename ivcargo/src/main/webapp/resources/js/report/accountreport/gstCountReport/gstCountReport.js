define([ 'marionette'
	...
	return Marionette.LayoutView.extend({
		initialize: function(){
			...
			getJSON(jsonObject, WEB_SERVICE_URL + '/clientWiseGSTCountReportWS/getInitialDetailsOfGstCount.do?', _this.setGroup, EXECUTE_WITHOUT_ERROR);
			return _this;
			...
			$("#mainContent").load("/ivcargo/html/report/accountreport/gstCountReport/gstCountReport.html",
					function() {
				baseHtml.resolve();
			});
			...
			getJSON(jsonObject, WEB_SERVICE_URL + "/clientWiseGSTCountReportWS/getDetailsOfGstCount.do?", _this.setResults, EXECUTE_WITH_ERROR );	
