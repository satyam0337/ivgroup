		...
		[
			...
			return Marionette.LayoutView.extend({
				initialize : function() {
					...
					showLayer();
					getJSON(jsonObject, WEB_SERVICE_URL	+ '/rateMasterWS/getFixedPartyCharges.do?',	_this.setFixedPartyRates, EXECUTE_WITHOUT_ERROR);
					return _this;
...
function rateUpdate(grid, dataView, row) {
	...
	btModalConfirm.on('ok', function() {
		...
		getJSON(jsonObject, WEB_SERVICE_URL+'/rateMasterWS/updateFixedPartyChargeRate.do', rateUpdateAction, EXECUTE_WITH_ERROR); //submit JSON
	});	
}
...
function rateDelete(grid, dataView, row) {
	...
	btModalConfirm.on('ok', function() {
		...
		getJSON(jsonObject, WEB_SERVICE_URL+'/rateMasterWS/deleteFixedPartyChargeRate.do', rateDeleteAction, EXECUTE_WITH_ERROR); //submit JSON
	});	
}
