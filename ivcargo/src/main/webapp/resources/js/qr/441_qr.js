    ...
    const html = `
        ...
        <body style="${data.bodyStyle}">
            <table cellpadding="0", cellspacing="0" border="0" style="width:100%;height:100%; margin-top:0px;padding:25px;">
				<tbody>
				<tr>
				 <table  style="width:100%;margin-top:25px;height:100%;padding-left:90px;">
				        <tbody>
				        <tr>
				            <td colspan="2" style="text-align: center;font-size: 75px;">RAJDHANI EXPRESS</td>
				        </tr>
				
				        <tr>
							<td style="vertical-align: top;">${qrCodeSvg}</td>
