...
function printBillWindow() {
	...
	$("#tableContain").load( "/ivcargo/html/print/delivery/772_deliveryprint.html", function() {
...
function getTotalAmt() {
	...
	if (deliveryBranch.branchId == 68044) {
	    companyHeader = '<strong>ARL PARCEL SERVICE</strong><br/>A Unit Of BOMBAY ANDHRA TRANSPORT P S';
	} else {
	    companyHeader = 'BOMBAY ANDHRA TRANSPORT P S';
	}
	console.log('companyHeader >>'+companyHeader);
