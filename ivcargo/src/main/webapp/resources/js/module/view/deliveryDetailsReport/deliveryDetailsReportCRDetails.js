...
define([
	PROJECT_IVUIRESOURCES + '/resources/js/module/view/deliveryDetailsReport/deliveryDetailsReportCRDetailsfilepath.js'
	,'jquerylingua'
	...
	return Marionette.LayoutView.extend({
		...
		render: function(){
			getJSON(jsonObject, WEB_SERVICE_URL+'/deliveryDetailsReportWS/getDeliveryDetailsReportCRWiseData.do', _this.setElementData, EXECUTE_WITH_ERROR);
		},setElementData : function(response) {

			$("#deliveryDetailsReportCRDetailsDiv").empty();
			...
			$("#mainContent").load("/ivcargo/html/report/deliveryDetailsReport/deliveryDetailsReportCRDetails.html",function() {
				baseHtml.resolve();
			});
