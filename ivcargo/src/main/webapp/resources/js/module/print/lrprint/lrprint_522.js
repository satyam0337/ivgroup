			...
			$('#popUpContent522').bPopup({
				...
				if(wayBillTypeId != WAYBILL_TYPE_CREDIT) {
					...
					+ "<div style='font-size:18px; color:DodgerBlue;text-align:center;'><b>Print Option</b><div><br/>"
							+ "<div style='text-align:left;color:black;font-size:17px;'><input type='checkbox' checked='checked' id='check'	 />&nbsp;<b style='font-size:14px;'>Print SIGN AND SEAL</b><div>"
						...
						$("#confirm").click(function() {
							if ($('#check').prop('checked'))
								$(".showSealAndSign").show();
							else
								$(".showSealAndSign").hide();
