						...
						for (var j = 0; j < consignmentDetailsArr[i].quantity; j++) {
							...
							if (isQrCodePrintBasedOnGSTN || isQrCodePrintBasedOnGSTN == true) {
								...
								if (isPrintIvcargoLableInQRCodePrint || isPrintIvcargoLableInQRCodePrint == true && false) {
									...
									dataObject.htmlTemplate = _.template('<table width="96%" style="margin-left:0px; border: solid 1px; margin-top:50px; "><tr><td height="100px" colspan="2" style="font-size:100px; border-bottom: solid 1px; border-left:solid 1px; border-top:solid 1px; border-right: solid 1px; padding: 0px 10px 0px 10px;text-align: center; ">' + dataObject.waybillNumber + ' - '+ dataObject.numberOfPackages +' </td></tr><tr><td colspan="2" height="80px" style="text-align: center;font-size:55px; border-bottom: solid 1px; border-left:solid 1px; border-top:solid 1px; border-right: solid 1px; padding: 0px 10px 0px 10px;">' + responseOut.wayBillDestinationBranchName + '</td></tr><tr><td height="80px"  style="font-size:45px; border-bottom: solid 1px; border-left:solid 1px; border-top:solid 1px; border-right: solid 1px; padding: 0px 10px 0px 10px;">Consignor Name:</td><td  style="font-size:45px; border-bottom: solid 1px; border-left:solid 1px; border-top:solid 1px; border-right: solid 1px; padding: 0px 10px 0px 10px;">' +consignorName + '</td></tr><tr><td height="80px"  style="font-size:45px; border-bottom: solid 1px; border-left:solid 1px; border-top:solid 1px; border-right: solid 1px; padding: 0px 10px 0px 10px;">Invoice No.: </td><td  style="font-size:45px; border-bottom: solid 1px; border-left:solid 1px; border-top:solid 1px; border-right: solid 1px; padding: 0px 10px 0px 10px;">' + invoiceNumberData.substring(0,18) + '</td></tr></table>')({ dataObject: dataObject });
									...
									$('#popUpContentForQrCodeOption_438').bPopup({
										...
										$(this).html("<div class='confirm' style='height:210px;width:250px; padding:5px'>"
											...
											//s+ "<div style='text-align:left;color:black;font-size:17px;' ><input type='checkbox' class='printData' id='printCharges'/> <span class='printData'><b style='font-size:14px;'>Print Charges</b></span><div><br/>"
										...
										$('#confirm').click(function() {
											...
											if ($('#printLR').prop('checked') == true && $('#printQR').prop('checked') == true) {
												_this.printAndCloseQRCodePrint();
													...
													_this.printQRCodeWithoutLimit(templateArray, 30);
