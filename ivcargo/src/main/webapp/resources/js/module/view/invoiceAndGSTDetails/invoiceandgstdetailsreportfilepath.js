define(function(require) {
	return {
		loadLanguage:function(){
			...
			globalLanguageObj.filePath 		= PROJECT_IVUIRESOURCES+'/resources/data/languages/module/invoiceandgstdetailsreport';
			//file name for language to be specified
			globalLanguageObj.fileName 		= 'invoiceandgstdetailsreport'
