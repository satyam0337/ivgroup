...
define([  'JsonUtility'
	,'messageUtility'
	,PROJECT_IVUIRESOURCES + '/resources/js/module/view/expenseVoucherApprovalReport/expenseVoucherApprovalReportFilePath.js'
	,'jquerylingua'
	,'language'
	,'selectizewrapper'
	,'nodvalidation'
	...
	,'slickGridWrapper2'
			 ...
			 BootstrapModal, Selection, slickGridWrapper2) {
	'use strict';
	...
	return Marionette.LayoutView.extend({
		initialize : function(masterObj) {
			...
			getJSON(jsonObject, WEB_SERVICE_URL	+ '/expenseVoucherApprovalReportWS/getExpenseVoucherApprovalReportElements.do?',_this.getElementConfigDetails,	EXECUTE_WITHOUT_ERROR);
			return _this;
			...
			$("#mainContent").load("/ivcargo/html/module/expenseVoucherApprovalReport/expenseVoucherApprovalReport.html",function() {
				baseHtml.resolve();
			});
			...
			getJSON(jsonObject, WEB_SERVICE_URL+'/expenseVoucherApprovalReportWS/getExpenseVoucherApprovalDetails.do', _this.setReportData, EXECUTE_WITH_ERROR);
			...
			var ColumnConfig		= response.ExpenseVoucherApprovalReport.columnConfiguration;
			...
			response.ExpenseVoucherApprovalReport.columnConfiguration			= _.values(bcolConfig);
			response.ExpenseVoucherApprovalReport.Language					= masterLangKeySet;
			
			hideLayer();
			gridObject = slickGridWrapper2.setGrid(response.ExpenseVoucherApprovalReport);
