define([
	...
	return Marionette.LayoutView.extend({
		initialize: function() {
			...
			getJSON(jsonObject, WEB_SERVICE_URL + '/report/pendingLuggageReportWS/getPendingLuggageReportElement.do?', _this.setPendingLuggageReportElements, EXECUTE_WITHOUT_ERROR);
			return _this;
		}, setPendingLuggageReportElements: function(response) {
			...
			$("#mainContent").load("/ivcargo/html/report/pendingLuggageReport/pendingLuggageReport.html", function() {
				baseHtml.resolve();
			});
			...
			getJSON(jsonObject, WEB_SERVICE_URL + '/report/pendingLuggageReportWS/getPendingLuggageReportDetails.do', _this.setReportData, EXECUTE_WITH_ERROR);
