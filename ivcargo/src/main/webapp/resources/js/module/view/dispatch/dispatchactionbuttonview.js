...
define(['elementTemplateJs',
        ...
        function(elementTemplateJs, filePath, actionButtonModel, actionButtonTemplate, loadModelUrls) {
	var 
	ElementModelArray='';
	var _this
	...
	var ActionButtonView = Marionette.ItemView.extend({
		...
		onRender: function(){
			...
			elementTemplateJs.appendElementInTemplate(loadModelUrls.urlModelForActionButton(), actionButtonModel, actionButtonTemplate, _this);
