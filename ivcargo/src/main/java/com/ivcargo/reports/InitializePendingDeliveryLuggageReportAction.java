...
public class InitializePendingDeliveryLuggageReportAction implements Action{

	public static final String TRACE_ID = "InitializePendingDeliveryLuggageReportAction";
	@Override
	public void execute(HttpServletRequest request, HttpServletResponse response) {
		...
		try {
			...
			if(confValObj.getBoolean(CommonReportsConfigurationDTO.CHANGE_LABEL_SOURCE_BRANCH_TO_FROM_BRANCH,false))
			...
			final var	subRegion	= cacheManip.getSubRegionsByGroupId(request, executive.getAccountGroupId(), isShowGroupMergingBranchData);
