define(['elementTemplateJs'
	...
	return ({
		renderElements : function(response){
			...
			require(['text!/ivcargo/template/preloading/preLoadingSheetPrint_734.html'],function(PreLoadingSheet){
			...
			$('#mainTable').empty();
			    ...
			    let headerColumnArray = [
			        '<th style="text-align: center;font-size:15px;  border-right: 1px solid black; border-bottom: 1px solid black;">SL.NO.</th>',
			        ...
			        '<th style="text-align: center;font-size:15px;  border-right: 1px solid black; border-bottom: 1px solid black;">CONSIGNEE NO</th>',
			        '<th style="text-align: center;font-size:15px;  border-right: 1px solid black; border-bottom: 1px solid black;">ART</th>',
			        '<th style="text-align: center;font-size:15px;  border-right: 1px solid black; border-bottom: 1px solid black;">PACKING TYPE</th>',
			        '<th style="text-align: center;font-size:15px;  border-right: 1px solid black; border-bottom: 1px solid black;">LR TYPE</th>',
          ...
          for (var i = 1; i < tableData.length; i++) {
				...
				dataColumnArray.push("<td style='font-size:15px; text-align: center; border-right: 1px solid black; border-bottom: 1px solid black;'>"+ el.consigneeMobileNumber +"</td>");
				...
				dataColumnArray.push("<td style='font-size:15px; text-align: center; border-right: 1px solid black; border-bottom: 1px solid black;'>"+ el.wayBillType +"</td>");
		    ...
		    for (let i=1; i <=headerColumnArray.length; i++) {
				if(i==10){
				 totalDataArray.push("<td style='font-size:15px; text-align: center; border-left: 1px solid black; border-right: 1px solid black; font-weight: bold;'>" +  totalBookingTotal + "</td>");
				  ...
				  totalDataArray.push("<td style='font-size:15px; text-align: center; font-weight: bold;'>" + totalNoOfQuantity + "</td>");
				}else{
