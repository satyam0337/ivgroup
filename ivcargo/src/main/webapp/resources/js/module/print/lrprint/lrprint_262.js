define([],function() {
    return ({
        renderElements : function() {
			...
			var partyIdsToShowBillingPartyWisePopupArr = conf.partyIdsToShowBillingPartyWisePopup.split(",");
			var showBillingPartyWisePopUpToHideCharges = conf.showBillingPartyWisePopUpToHideCharges;
			var billingPartyId = responseOut.billingPartyId;
			var _this = this;

			$('#popUpContent262').bPopup({
				}, function() {
					var _thisMod = this;
					if (showBillingPartyWisePopUpToHideCharges && wayBillTypeId == WAYBILL_TYPE_CREDIT && isValueExistInArray(partyIdsToShowBillingPartyWisePopupArr, billingPartyId)) {
						$(this).html("<div class='confirm' style='height:150px;width:250px; padding:5px'>"
							...
							+ "<div style='text-align:left;color:black;font-size:17px;'><input type='checkbox'  id='check1' checked />&nbsp;<b style='font-size:14px;'>Print Charges</b><div>"
