define([
	PROJECT_IVUIRESOURCES + '/resources/js/module/view/newCashStatementReport/newCashStatementReportBankPaymentDetailsfilepath.js'
	,'jquerylingua'
	...
	return Marionette.LayoutView.extend({
		...
		render: function(){
			getJSON(jsonObject, WEB_SERVICE_URL+'/newCashStatementReportWS/getNewCashStatementReportBankPaymentData.do', _this.setElementData, EXECUTE_WITHOUT_ERROR);
			...
			$("#mainContent").load("/ivcargo/html/report/newCashStatementReport/newCashStatementReportBankPaymentDetails.html",function() {
				baseHtml.resolve();
			});
