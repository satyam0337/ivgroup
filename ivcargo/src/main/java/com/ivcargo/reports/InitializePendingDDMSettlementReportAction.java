...
public class InitializePendingDDMSettlementReportAction implements Action{

	public static final String TRACE_ID = "InitializePendingDDMSettlementReportAction";
	@Override
