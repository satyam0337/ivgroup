define(['elementTemplateJs'
	...
	return ({
		renderElements : function(response){
			...
			require(['text!/ivcargo/template/preloading/preLoadingSheetPrint_935.html'],function(PreLoadingSheet){
			...
			$('#mainTable').empty();
			    ...
			    let headerColumnArray = [
			        ...
			        '<th style="text-align: center;font-size:15px;  border-right: 1px solid black; border-bottom: 1px solid black;">LR Date</th>',
			        ...
			        '<th style="text-align: center;font-size:15px;  border-right: 1px solid black;border-bottom: 1px solid black;">Basic Frieght</th>',
			        '<th style="text-align: center;font-size:15px; border-bottom: 1px solid black; border-bottom: 1px solid black; "> Quantity</th>',
			        '<th style="text-align: center;font-size:15px;  border-right: 1px solid black; border-bottom: 1px solid black;">Packing Type</th>',
			        '<th style="text-align: center;font-size:15px;  border-right: 1px solid black; border-bottom: 1px solid black;height:50px;"> Remarks </th>',
          ...
          for (var i = 1; i < tableData.length; i++) {
   			...
   			function formatEwaybillNumbers(ewaybillNumber) {
				...
				dataColumnArray.push("<td style='text-align: center; border-right: 1px solid black; border-bottom: 1px solid black;'>"+ el.wayBillFreightCharge +"</td>");
				...
				dataColumnArray.push("<td style='text-align: center; border-right: 1px solid black; border-bottom: 1px solid black;width:20%;height:50px;'> &nbsp; </td>"); 
