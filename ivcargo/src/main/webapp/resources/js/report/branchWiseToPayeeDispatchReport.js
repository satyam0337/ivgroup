define([
	...
	return Marionette.LayoutView.extend({
		initialize: function() {
			...
			getJSON(jsonObject, WEB_SERVICE_URL + '/report/branchWiseToPayeeDispatchReportWS/getBranchWiseToPayeeDispatchReportElement.do?', _this.setBranchWiseToPayeeDispatchReportElements, EXECUTE_WITHOUT_ERROR);
			return _this;
		}, setBranchWiseToPayeeDispatchReportElements: function(response) {
			...
			$("#mainContent").load("/ivcargo/html/report/branchWiseToPayeeDispatchReport/branchWiseToPayeeDispatchReport.html", function() {
				baseHtml.resolve();
			});
			...
			getJSON(jsonObject, WEB_SERVICE_URL + '/report/branchWiseToPayeeDispatchReportWS/getBranchWiseToPayeeDispatchReportDetails.do', _this.setReportData, EXECUTE_WITH_ERROR);
