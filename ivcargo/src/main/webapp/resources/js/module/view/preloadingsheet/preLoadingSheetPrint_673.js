define(['elementTemplateJs'
	...
	return ({
		renderElements : function(response){
			...
			require(['text!/ivcargo/template/preloading/preLoadingSheetPrint_673.html'],function(PreLoadingSheet){
				...
				$('.totalActualWeight').html(totalActualWeight);
				...
				_this.setTableRowData(finalJsonObj,allTypeChargedWeightTotal,totalBookingTotal,totalNoOfQuantity,totalActualWeight,bookingTotalToPay,noOfLRPaid,noOfLRToPay,noOfLRTBB);
				hideLayer();	
				_this.showPrintOnPopup();
			})
			
		},setTableRowData:function(tableData,allTypeChargedWeightTotal,totalBookingTotal,totalNoOfQuantity,totalActualWeight,bookingTotalToPay,noOfLRPaid,noOfLRToPay,noOfLRTBB){
			hideLayer();
			$('#mainTable').empty();
			...
			let headerColumnArray = [
				...
				'<th style="text-align: center;font-size:15px;  border-right: 1px solid black; border-bottom: 1px solid black;">QTY</th>',
				...
				'<th style="text-align: center;font-size:15px;  border-right: 1px solid black; border-bottom: 1px solid black;">REMARK</th>',
			];
			...
			for (var i = 0; i < tableData.length; i++) {
				...
				dataColumnArray.push("<td style='font-size:15px; text-align: center; border-right: 1px solid black; border-bottom: 1px solid black;'>"+ saidToContainComma +"</td>");
				// Apply ellipsis to consignorName and consigneeName columns
				dataColumnArray.push("<td style='font-size:15px; text-align: center;  border-right: 1px solid black; border-bottom: 1px solid black;'>"+ el.consignmentSummaryActualWeight +"</td>");
				dataColumnArray.push("<td style='font-size:15px; text-align: center;  border-right: 1px solid black; border-bottom: 1px solid black;'>"+ el.wayBillRemark +"</td>");
			...
			for (let i=1; i <=headerColumnArray.length; i++) {
				if(i==2){
					...
					totalDataArray.push("<td style='font-size:15px; border-right: 1px solid black; text-align: center; font-weight: bold;'>" + totalActualWeight + "</td>");
				}else{
