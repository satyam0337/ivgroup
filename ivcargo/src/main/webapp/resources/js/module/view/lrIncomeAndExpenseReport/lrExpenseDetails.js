...
define([
	 PROJECT_IVUIRESOURCES + '/resources/js/module/view/lrIncomeAndExpenseReport/lrExpenseDetailsfilepath.js'
	,'jquerylingua'
	...
	return Marionette.LayoutView.extend({
		...
		render: function(){
			getJSON(jsonObject, WEB_SERVICE_URL + '/lrIncomeAndExpenseReportWS/getLRExpenseDetails.do?', _this.setElementData, EXECUTE_WITHOUT_ERROR);
		},setElementData : function(response) {

			$("#lrExpenseDetailsDiv").empty();
			...
			setTimeout(function(){
				$("#modalBody").load("/ivcargo/html/report/lrIncomeAndExpenseReport/lrExpenseDetails.html",function() {
					baseHtml.resolve();
				});
			},200);
