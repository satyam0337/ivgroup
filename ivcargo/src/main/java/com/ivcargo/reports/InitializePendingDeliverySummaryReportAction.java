...
public class InitializePendingDeliverySummaryReportAction implements Action {
	...
	public void execute(HttpServletRequest request, HttpServletResponse response) {
		...
		try {
			...
			request.setAttribute("fromSubregionLabel", "Destination SubRegion");
			request.setAttribute("cityBranchLabel", "Destination Branch");
			request.setAttribute("agencyBranchLabel", "Destination Branch");
			...
			request.getSession().getServletContext().getAttribute("group"+ executive.getAccountGroupId());
