define(['elementTemplateJs'
	...
	return ({
		renderElements : function(response){
			...
			console.log(finalJsonObj,'finl')
			require(['text!/ivcargo/template/preloading/preLoadingSheetPrint_754.html'],function(PreLoadingSheet){
			...
			$('#mainTable').empty();
			    ...
			    let headerColumnArray = [
			        '<th style="text-align: center;font-size:15px;  border-right: 1px solid black; border-bottom: 1px solid black;">No</th>',			  
			        '<th style="text-align: center;font-size:15px;  border-right: 1px solid black; border-bottom: 1px solid black;">LR </th>',
			        '<th style="text-align: center;font-size:15px;  border-right: 1px solid black; border-bottom: 1px solid black;">PARCEL DATE</th>',
			        ...
			        '<th style="text-align: center;font-size:15px;  border-right: 1px solid black; border-bottom: 1px solid black;">Total Parcels</th>',
			        '<th style="text-align: center;font-size:15px;  border-right: 1px solid black;border-bottom: 1px solid black;">DESTINATION</th>',
			        '<th style="text-align: center;font-size:15px; border-bottom: 1px solid black; border-bottom: 1px solid black; ">LR TYPE</th>',
			        '<th style="text-align: center;font-size:15px;  border-right: 1px solid black; border-bottom: 1px solid black;">AMOUNT</th>',
			        '<th style="text-align: center;font-size:15px;  border-right: 1px solid black; border-bottom: 1px solid black;"> E-WAYBILL NO </th>',
          ...
          for (var i = 1; i < tableData.length; i++) {
   			...
   			function formatEwaybillNumbers(ewaybillNumber) {
				...
				dataColumnArray.push("<td style='text-align: center; border-right: 1px solid black; border-bottom: 1px solid black;'>"+ formatEwaybillNumbers(el.ewaybillNumber) +"</td>");
