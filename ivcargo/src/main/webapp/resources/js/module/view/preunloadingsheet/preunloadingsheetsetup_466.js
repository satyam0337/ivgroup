define(['elementTemplateJs'],function(elementTemplateJs){
	...
	return ({
		renderElements : function(response){
			...
			require(['text!/ivcargo/template/preunloading/preunloadingsheet_466.html'],function(PreLoadingSheet){
				var noOfLr		 	= 0;
				var noOfArticle 	= 0;
				var actualWeight 	= 0;
				var chargeWeight	= 0;
				...
				$('.bookingAmount').html(bookingAmount);
					...
					$('div', left).each(function() {
						if(typeof $(this).attr('data-cell') != "undefined" ){
							if(chunkArray[chunk][$(this).attr('data-cell')] != undefined){
								...
								console.log("chunkArray[chunk]",chunkArray[chunk]);
							}else{
