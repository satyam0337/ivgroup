...
public class VehicleUnloadingInProgressAction implements Action {
	private static final String TRACE_ID = "VehicleUnloadingInProgressAction";
	...
	public void execute(HttpServletRequest request, HttpServletResponse response) {
		...
		try {
			...
			if(branchIds != null && branchIds.length() > 0){
				...
				inValueObject.put("status",VehiclePendingForUnLoading.STATUS_UNLOADING_IN_PROGRESS);
