define(function(require) {
	return {
		loadLanguage:function(){
			...
			globalLanguageObj.filePath 		= PROJECT_IVUIRESOURCES+'/resources/data/languages/module/preloadingSheetModulePrint';
			//file name for language to be specified
			globalLanguageObj.fileName 		= 'preloadingsheetmoduleprint_default'
