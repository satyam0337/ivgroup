...
function printLhpvWindow() {
	$("#tableContain").load( "/ivcargo/jsp/print/lhpv/772/batpsLHPVPrint.html", function() {
		printAfterDelay();
...
function setBanckDetails(){
	setValueToHtmlTag('bankName', vehicleNumberMaster.bankName);
	setValueToHtmlTag('partyName', vehicleNumberMaster.bankName);
	setValueToHtmlTag('acountNumber', vehicleNumberMaster.accountNo);
	...
	setValueToHtmlTag('partyName', vehicleNumberMaster.registeredOwner);
}
