        ...
        renderElements : function(){
			...
			$('#popUpContent634').bPopup({
						...
						$(this).html("<div class='confirm' style='height:150px;width:250px; padding:5px'>"
							...
							+ "<div style='text-align:left;color:black;font-size:17px;'><input type='checkbox' checked='checked' id='check1'  />&nbsp;<b style='font-size:14px;'>Print unit</b><div>"
